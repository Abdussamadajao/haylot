...
const LifePackCard = () => {
  return (
    <View className="w-[380px] h-[192px] border border-[#FFFFFF1a] bg-[#0000001F] rounded-xl mb-7">
      <View className="bg-[#FF289CCC] rounded-t-xl">
      ...
      <View className="flex flex-row justify-between  py-5 px-10">
        <View className="flex items-center space-y-2">
          <Image source={Heart} className={`w-[34px] h-[32px]`} />
        ...
        <View className="flex items-center space-y-2 ml-3">
          <View className="flex flex-row">
            <Image source={Heart} className={`w-[34px] h-[32px] left-2`} />
            <Image source={Heart} className={`w-[34px] h-[32px] `} />
            <Image source={Heart} className={`w-[34px] h-[32px] right-2`} />
          </View>
        ...
        <View className="flex items-center space-y-2 -ml-3">
          <View className="flex flex-row relative justify-center items-center  ">
            <Image source={Heart} className={`w-[34px] h-[32px] left-6`} />
            <Image source={Heart} className={`w-[34px] h-[32px] left-3`} />
            <Image source={Heart} className={`w-[34px] h-[32px] `} />
            <Image source={Heart} className={`w-[34px] h-[32px] right-2`} />
          </View>
